<template>
  <v-container fluid grid-list-xs class="pt-10">
                ...
                <v-container grid-list-xs>
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="6" class="py-1 px-0 text-center mr-1">
                      <v-text-field v-model.trim="new_user.acct_no" solo dense type="email" label="Email Address"
                  ...
                  <v-btn to="auth" block text class="white indigo--text mx-1 mt-12">LOGIN</v-btn>
                </v-container>
              </v-stepper-content>
                ...
                <v-container grid-list-xs>
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="10" class="py-1 px-0 text-center mr-1">
                      <v-text-field v-model.trim="new_user.last_name" solo dense label="Last Name"
                        class="pa-0 mb-5"></v-text-field>
                ...
                <v-container grid-list-xs>
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="4" class="py-1 px-0 text-center mr-1">
                      <v-text-field v-model.trim="new_user.pin" solo dense label="PIN" type="password"
                        class="pa-0 mb-5"></v-text-field>
                      <v-text-field v-model.trim="re_pin" solo dense type="password" label="RE-TYPE PIN"
                        class="pa-0 mb-5"></v-text-field>
