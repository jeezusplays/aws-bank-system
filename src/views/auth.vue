                ...
                <v-container grid-list-xs>
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="6" class="py-1 px-0 text-center mr-1">
                      <v-text-field v-model.trim="acct_no" solo dense label="Email Address" placeholder="Email Address"
                        hide-details class="pa-0 mb-5"></v-text-field>
                      <v-btn class="white indigo--text mb-12" @click="e1 = 2" icon fab>
                        <v-icon large>mdi-chevron-right</v-icon>
                      </v-btn>
                    </v-col>
                  </v-row>
                  <v-btn to="register" block text class="white indigo--text mx-1 mt-12">REGISTER</v-btn>
                </v-container>
                ...
                <v-container grid-list-xs class="">
                  <v-row no-gutters class="d-flex">
                    <v-col cols="4" class="py-1 px-0 text-center mx-auto">
                      <v-text-field v-model="pin" solo dense label="ACCOUNT PIN" type="password" placeholder="PIN"
                        hide-details class="pa-0" id="id"></v-text-field>
                    </v-col>
                  </v-row>
                </v-container>
                <v-spacer></v-spacer>
